...
import net.quduo.pixel.interfaces.android.activity.WebViewActivity;
...
public class UserFragment extends Fragment {
    ...
    private RelativeLayout mSettingActionItem;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSettingActionItem = (RelativeLayout) view.findViewById(R.id.setting_action_item);
        mSettingActionItem.setOnClickListener(new View.OnClickListener() {
